...
import tarapic from '../../assets/myPic.JPG';
...
const About = () => {
  ...
  return (
    <div className="Hero px-4 mt-6 md:mt-32 border md:flex justify-between "> 
        ...
        <div className="border flex justify-center mt-20 md:mt-0">
